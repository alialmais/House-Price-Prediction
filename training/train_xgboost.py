...
ax1.set_title("Model Evaluation: RMSE")
plt.savefig("models/model_rmse_chart.png")
plt.show()
...
ax2.set_title("Model Evaluation: R² Score")
plt.savefig("models/model_r2_chart.png")
plt.show()

print("Model evaluation charts saved successfully!")
